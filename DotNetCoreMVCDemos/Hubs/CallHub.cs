...
namespace DotNetCoreMVCDemos.Hubs
{
    public class CallHub : Hub<ICallHub>
    {
        ...
        public CallHub(List<User> users, List<UserCall> userCalls, List<CallOffer> callOffers, IHttpContextAccessor httpContextAccessor)
        {
            _Users = users;
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            _Users.Add(new User
            {
                Username = session.GetString("UserId"),
                ConnectionId = Context.ConnectionId
            });
